...
namespace ShareX
{
    ...
    {
        public List<OldItems> NewsItems { get; private set; } = new List<OldItems>();
        ...
        public void UpdateUnread()
        {
            if (NewsItems != null)
            {
                foreach (OldItems newsItem in NewsItems)
                {
        ...
        private async Task<List<OldItems>> GetNews()
        {
            ...
            if (!string.IsNullOrEmpty(response))
            {
                ...
                return JsonConvert.DeserializeObject<List<OldItems>>(response, settings);
            }

            return null;
        }

        private void ExportNews(List<OldItems> newsItems)
        {
            JsonSerializerSettings settings = new JsonSerializerSettings
            {
